...
- feat: update package ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat: eslint > allow import declarations which import private modules ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(import/namespace): allow imported namespaces contain dereferenced properties ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(import/no-named-default): allow named default exports ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(package.json): bump up package ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(minimum and maximum identifier lengths): turn it off min and max identifier lengths ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
...
- fix(eslint.js): remove eslint-tailwind plugin ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
...
- 1.9.0 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.9 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.7 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(@typescript-eslint/no-parameter-properties): remove rules > as not used anymore ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.6 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.5 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- feat(@typescript-eslint/no-duplicate-imports): remove as deprecated ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.4 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.3 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.2 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
- v1.8.1 ([@ugistelmokaitis](https://github.com/ugistelmokaitis))
